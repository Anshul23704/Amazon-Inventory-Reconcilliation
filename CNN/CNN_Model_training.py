...
parser.add_argument('--data', metavar='DIR', default='D:/Sem5_Subjects/ML/MINIpORJ/Image-Inventory-Reconciliation-with-SVM-and-CNN-master/data/Allimages', help='path to dataset')
...
#             param.requires_grad = True
    ...
    val_json = "D:/Sem5_Subjects/ML/MINIpORJ/Image-Inventory-Reconciliation-with-SVM-and-CNN-master/counting_val.json"
    data_dir = "D:/Sem5_Subjects/ML/MINIpORJ/Image-Inventory-Reconciliation-with-SVM-and-CNN-master/data/Allimages"

    train_loader = torch.utils.data.DataLoader(
        data_utils.ImageFolderCounting(data_dir, train_json, transforms.Compose([
    ...
    val_loader = torch.utils.data.DataLoader(
        data_utils.ImageFolderCounting(data_dir, val_json, transforms.Compose([
            transforms.ToTensor(),
            normalize,
        ])),
